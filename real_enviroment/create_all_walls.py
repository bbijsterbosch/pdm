...
wall_x_2_list = wall_of_n_spheres_x([-4, -1, 0], 0.4, 10)
    
wall_y_list = wall_of_n_spheres_y([0, -4, 0], 0.4, 7)
wall_y_2_list = wall_of_n_spheres_y([3, -4, 0], 0.4, 7)
wall_y_3_list = wall_of_n_spheres_y([3, 1, 0], 0.4, 6)

    
wall_y_5_list = wall_of_n_spheres_y([3, 9, 0], 0.4, 6)

wall_x_3_list = wall_of_n_spheres_x([6, 3, 0], 0.4, 6)
